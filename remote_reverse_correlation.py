...
def average_band_response_generator(spikes,onset_times,tau_max,duration,Fs,n_fibres_per_ihc=10.):
    ...
    #average firing counts across number of presentations and fibres
...
output_directory = '/tmp/rob_test_results/'
...
np.savez_compressed(input_directory+test_file+'_reverse_correlation_data.npz',original_stimulus=tone_1,
                    average_band_response=average_band_response,
                     average_band_response_test = average_band_response_test)
